            ...
            $(function () {
                $('#users_table').DataTable({
                    ...
                    columns: [
                        ...
                        {data: 'bet', name: 'balance.bet'},
                        {data: 'bonus', name: 'balance.bonus'},
                        {data: 'participation', name: 'bidsCount.participation'},
                        {data: 'win', name: 'bidsCount.win'},
                        {data: 'count_referral', name: 'ref.count_referral'},
