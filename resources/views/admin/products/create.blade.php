    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Добавление шаблона </h6>
            </div>
            <div class="card-body">
                <form action="{{route('admin.products.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input onkeyup="validWidth(this,14)" type="text" class="form-control @error('short_desc') is-invalid @enderror"
                                   id="short_desc" name="short_desc" value="{{old('short_desc')}}">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="company_id" id="company_id">
                                @foreach($companies as $company)
                                    <option @if((int)old('company_id')===(int)$company->id) selected
                        ...
                        <div class="col-sm-10">
                            <select class="form-control" name="category_id" id="category_id">
                                @foreach($categories as $category)
                                    <option @if((int)old('category_id')===(int)$category->id) selected
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('start_price') is-invalid @enderror"
                                   id="start_price"
                                   name="start_price" value="{{old('start_price')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('full_price') is-invalid @enderror"
                                   id="full_price"
                                   name="full_price" value="{{old('full_price')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number"
                                   ...
                                   id="step_time"
                                   name="step_time" min="1" value="{{old('step_time')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number"
                                   ...
                                   id="step_price"
                                   name="step_price" min="1" value="{{old('step_price')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="number"
                                   ...
                                   id="to_start"
                                   name="to_start" min="1" value="{{old('to_start')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input type="checkbox" @if(old('exchange')==='on') checked
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input type="checkbox" @if(old('buy_now')==='on') checked
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-check">
                                <input type="checkbox" @if(old('visibly')==='on') checked
