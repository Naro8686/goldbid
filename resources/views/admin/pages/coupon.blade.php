                    ...
                    <table class="table table-striped" width="100%" cellspacing="0" align="center">
                        ...
                        @foreach($packages as $package)
                            <tr>
                                ...
                                <td>
                                    <button type="button"
                                            class="btn btn-sm btn-toggle @if($package->visibly) active @endif"
                                            data-toggle="button" @if($package->visibly) aria-pressed="true"
                                            @else aria-pressed="false" @endif  autocomplete="off"
                                            onclick='oNoFF("{{route('admin.packages.update',[$package->id])}}",{visibly:($(this).attr("aria-pressed") === "true" ? 0 : 1),},"PUT")'>
