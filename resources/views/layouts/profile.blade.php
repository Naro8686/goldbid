        ...
        <div class="container">
            <div class="left">
                ...
                <div class="info">
                    ...
                    <p class="bid">Ставки: {{$user->balance()->bet}} шт</p>
                    <p class="bonus">Бонусы: {{$user->balance()->bonus}} шт</p>
                </div>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <a href="{{route('profile.personal')}}">
                                <p class="tab @if(request()->is('cabinet/personal')) whiteborder @endif">Персональные данные</p>
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <a href="{{route('profile.auctions_history')}}">
                                <p class="tab @if(request()->is('cabinet/auction-history')) whiteborder @endif">История моих аукционов</p>
                            </a>
                        </li>
                        <li>
                            <img src="{{asset('site/img/5cat.png')}}" alt="">
                            <a href="{{route('profile.referral_program')}}">
                                <p class="tab @if(request()->is('cabinet/referral-program')) whiteborder @endif">Реферальная программа</p>
                            </a>
                        </li>
                        <li>
                            <img src="{{asset('site/img/4cat.png')}}" alt="">
